...
public class Expert extends AgentDecorator {
    ...
    public Expert(Agent a) {
        super(a);
        this.setDecoratedAgent(a);
        this.getDecoratedAgent().setAgentUpdate('e');
    }
    ...
    public void draw(Graphics2D g2d) {
        ...
        g2d.fillRect(getDecoratedAgent().getPosition().getIntX() + 60, getDecoratedAgent().getPosition().getIntY() - 33, 10, 10);
