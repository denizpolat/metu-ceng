...
//
//    for (int i = 0; i < scene.meshes.size(); ++i) {
//        parser::Mesh mesh = scene.meshes.at(i);
//        for (int i = 0; i < mesh.faces.size(); i++) {
//            parser::Face face = mesh.faces.at(i);
//
//            parser::Vec3f vertex0, vertex1, vertex2;
//
//            vertex0 = scene.vertex_data.at(face.v0_id - 1);
//            vertex1 = scene.vertex_data.at(face.v1_id - 1);
//            vertex2 = scene.vertex_data.at(face.v2_id - 1);
//
//
//            glNormal3f(normals.at(face.v0_id -1 ).x,  normals.at(face.v0_id - 1).y, normals.at(face.v0_id -1).z ); // Normal of vertex
//
//            glVertex3f(vertex0.x, vertex0.y, vertex0.z); // Position of vertex
//
//            glNormal3f(normals.at(face.v1_id - 1).x,  normals.at(face.v1_id - 1).y, normals.at(face.v1_id - 1).z ); // Normal of vertex
//
//            glVertex3f(vertex1.x, vertex1.y, vertex1.z); // Position of vertex
//
//            glNormal3f(normals.at(face.v2_id - 1).x,  normals.at(face.v2_id - 1) .y, normals.at(face.v2_id - 1).z ); // Normal of vertex
//
//            glVertex3f(vertex2.x, vertex2.y, vertex2.z); // Position of vertex
//
//        }
//    }
//
...
void initScene() {
    ...
    glBindBuffer(GL_ARRAY_BUFFER, gpuNormalBuffer);
    glBufferData(GL_ARRAY_BUFFER, numVertices * 3 * sizeof(GLfloat), normalData, GL_STATIC_DRAW);
...
//    setLights();
//    setCamera();
//    //l0_enable=l1_enable=l2_enable=1;
