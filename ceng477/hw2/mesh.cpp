...
namespace fst
{
    Mesh::Mesh(const std::vector<Triangle>& triangles, int material_id, std::string  transforms)
	: m_triangles(triangles)
        , m_material_id(material_id)
        , transformations(std::move(transforms))
    {}



    Mesh::Mesh(std::vector<Triangle>&& triangles, int material_id, std::string  transforms)
